...
scr_button(96,346,96+100,346+100,buttonColor,buttonSelected,2,0,0,oBeachBallFalling,"Ball \n (Cost: 2)");
scr_button(204,346,204+100,346+100,buttonColor,buttonSelected,1,0,0,oFood,"Food \n (Cost: 1)");
scr_button(320,346,320+100,346+100,buttonColor,buttonSelected,8,0,0,oBoneFalling,"Bone \n (Cost: 8)");
scr_button(436,346,436+100,346+100,buttonColor,buttonSelected,3,0,0,oSteakFalling,"Steak \n (Cost: 3)");

//Furnitur
draw_set_color(c_black);
draw_text(72 + 26,562 - string_height("FURNITURE") - 5,"FURNITURE:");
if(!instance_exists(oWriting)){
scr_button(96,562,96+100,562+100,buttonColor,buttonSelected,1,0,0,oWriting,"Writing \n (Cost: 1)");
}
